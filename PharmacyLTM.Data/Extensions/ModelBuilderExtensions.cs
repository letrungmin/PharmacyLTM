    ...
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<AppConfig>().HasData(
               new AppConfig() { Key = "HomeTitle", Value = "This is home page of PharmacyLTM" },
               new AppConfig() { Key = "HomeKeyword", Value = "This is keyword of PharmacyLTM" },
               new AppConfig() { Key = "HomeDescription", Value = "This is description of PharmacyLTM" }
               );
